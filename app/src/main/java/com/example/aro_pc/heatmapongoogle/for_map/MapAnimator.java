...
//   }
    ...
    public void animateLine(final GoogleMap googleMap, final List<LatLng> alLatLng) {
        ...
        percentageCompletion.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if((startCount[0] - countTobeRemoved / 8) < countTobeRemoved){
                    ...
                    polyline.setPoints(subListTobeRemoved);
...
//                foregroundPolyline.setPoints(backgroundPolyline.getPoints());
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                List<LatLng> foregroundPoints = alLatLng;
        ...
        valueAnimator.addListener(new Animator.AnimatorListener() {
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                backgroundPolyline.setPoints(polyline.getPoints());
        ...
        firstRunAnimSet.playSequentially(valueAnimator,
                percentageCompletion);
        firstRunAnimSet.addListener(new Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(Animator animation) {
